 ...
 * @author jimsch
 */
public class EncryptCOSEObject extends EncryptCommon {

  protected List<Recipient> recipientList = new ArrayList<>();

  public EncryptCOSEObject() {
    this(true);
  }

  public EncryptCOSEObject(boolean emitTag) {
    this.emitTag = emitTag;
    coseObjectTag = COSEObjectTag.Encrypt;
    context = "Encrypt";
  }
